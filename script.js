//Create an Joke Random Generator WebPage

let jokeList = ["Which is faster, hot or cold? Hot, because you can catch cold",
...
function displayRandomJokes() {
    let jokeRandomNum = Math.floor(Math.random() * jokeList.length);
    document.getElementById('jokeDisplay').innerHTML = jokeList[jokeRandomNum];
